...
from tornados.concurrent import TracebackFuture
from tornados.escape import utf8, native_str, to_unicode
from tornados import httpclient, httputil
from tornados.ioloop import IOLoop
from tornados.iostream import StreamClosedError
from tornados.log import gen_log, app_log
from tornados import simple_httpclient
from tornados.tcpclient import TCPClient
from tornados.util import _websocket_mask, PY3
...
class WebSocketHandler(tornados.web.RequestHandler):
    ...
    def get(self, *args, **kwargs):
        ...
        if self.ws_connection:
            ...
            if not self.stream.closed():
                self.stream.write(tornados.escape.utf8(
    ...
    def write_message(self, message, binary=False):
        ...
        if isinstance(message, dict):
            message = tornados.escape.json_encode(message)
...
class _PerMessageDeflateCompressor(object):
    ...
    def _create_compressor(self):
        return zlib.compressobj(tornados.web.GZipContentEncoding.GZIP_LEVEL,
...
class WebSocketProtocol13(WebSocketProtocol):
    ...
    def write_message(self, message, binary=False):
        ...
        if binary:
            ...
            opcode = 0x1
        message = tornados.escape.utf8(message)
