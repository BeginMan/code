...
from tornados import httputil
from tornados import iostream
from tornados import locale
from tornados.log import access_log, app_log, gen_log
from tornados import stack_context
from tornados import template
from tornados.escape import utf8, _unicode
from tornados.util import (import_object, ObjectDict, raise_exc_info,
                          unicode_type, _websocket_mask, re_unescape, PY3)
from tornados.httputil import split_host_and_port
...
class Application(httputil.HTTPServerConnectionDelegate):
    ...
    def __init__(self, handlers=None, default_host="", transforms=None,
        ...
        if self.settings.get('autoreload'):
            from tornados import autoreload
            autoreload.start()
    ...
    def listen(self, port, address="", **kwargs):
        ...
        from tornados.httpserver import HTTPServer
