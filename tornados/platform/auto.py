...
if 'APPENGINE_RUNTIME' in os.environ:
    from tornados.platform.common import Waker

    def set_close_exec(fd):
        pass
elif os.name == 'nt':
    from tornados.platform.common import Waker
    from tornados.platform.windows import set_close_exec
else:
    from tornados.platform.posix import set_close_exec, Waker
