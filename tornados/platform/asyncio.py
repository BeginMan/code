...
def to_tornado_future(asyncio_future):
    ...
    .. versionadded:: 4.1
    """
    tf = tornados.concurrent.Future()
    tornados.concurrent.chain_future(asyncio_future, tf)
    return tf
...
def to_asyncio_future(tornado_future):
    ...
    af = asyncio.Future()
    tornados.concurrent.chain_future(tornado_future, af)
    return af
